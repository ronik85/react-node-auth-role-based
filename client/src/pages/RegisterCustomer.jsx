...
const RegisterCustomer = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.post("http://localhost:5000/api/auth/register", customer);
    ...
    return (
        <div className="w-full max-w-md p-6 bg-white rounded-lg shadow-md">
            <h2 className="text-2xl font-bold text-center text-gray-700">Customer Registration</h2>
            <form onSubmit={handleSubmit} className="mt-4">
                ...
                <button type="submit" className="w-full p-2 mt-4 text-white bg-blue-500 rounded-md">Register</button>
            </form>
        </div>
    );
};
